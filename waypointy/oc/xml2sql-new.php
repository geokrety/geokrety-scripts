...
$BAZY_OC['de']['url'] = "http://www.opencaching.de/xml/ocxml11.php?cache=1&session=0&charset=utf-8&cdata=1&xmldecl=1&ocxmltag=1&doctype=0&zip=0&modifiedsince=";
$BAZY_OC['de']['szukaj'] = 'http://www.opencaching.de/searchplugin.php?userinput=';


$BAZY_OC['pl']['prefix'] = 'OP';
$BAZY_OC['pl']['url'] = "http://www.opencaching.pl/xml/ocxml11.php?cache=1&session=0&charset=utf-8&cdata=1&xmldecl=1&ocxmltag=1&doctype=0&zip=0&modifiedsince=";
$BAZY_OC['pl']['szukaj'] = 'http://www.opencaching.pl/searchplugin.php?userinput=';

$BAZY_OC['uk']['prefix'] = 'OK';
$BAZY_OC['uk']['url'] = "http://www.opencaching.org.uk/xml/ocxml11.php?cache=1&session=0&charset=utf-8&cdata=1&xmldecl=1&ocxmltag=1&doctype=0&zip=0&modifiedsince=";
$BAZY_OC['uk']['szukaj'] = 'http://www.opencaching.org.uk/searchplugin.php?userinput=';
...
foreach ($BAZY_OC as $key => $baza) {
    ...
    if ($GLOBALS['argv'][1] == 'full') {
        $modifiedsince = "20030101000000";
    }
    //$modifiedsince = "20150701000000";
    ...
    foreach ($xml->cache as $cache) {
        ...
        $name = trim(mysqli_real_escape_string(strtr((string) $cache->name, array('"' => ''))));
        $owner = mysqli_real_escape_string((string) $cache->userid);
